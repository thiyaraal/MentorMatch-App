...
MentorProfile mentorProfileFromMap(String str) => MentorProfile.fromMap(json.decode(str));
...
class User {
    ...
    factory User.fromMap(Map<String, dynamic> json) => User(
        ...
        experiences: json["experiences"] == null ? [] : List<ExperienceMentor>.from(json["experiences"]!.map((x) => ExperienceMentor.fromMap(x))),
    );
...
class ExperienceMentor {
    ...
    factory ExperienceMentor.fromMap(Map<String, dynamic> json) => ExperienceMentor(
        id: json["id"],
        userId: json["userId"],
