...
class MentorSMA {
    ...
    factory MentorSMA.fromMap(Map<String, dynamic> json) => MentorSMA(
        ...
        mentorClass: json["class"] == null ? [] : List<ClassMentorSMA>.from(json["class"]!.map((x) => ClassMentorSMA.fromMap(x))),
        mentorReviews: json["mentorReviews"] == null ? [] : List<dynamic>.from(json["mentorReviews"]!.map((x) => x)),
        experiences: json["experiences"] == null ? [] : List<ExperienceSMA>.from(json["experiences"]!.map((x) => ExperienceSMA.fromMap(x))),
    );
...
class ClassMentorSMA {
    ...
    factory ClassMentorSMA.fromMap(Map<String, dynamic> json) => ClassMentorSMA(
        ...
        transactions: json["transactions"] == null ? [] : List<TransactionSMA>.from(json["transactions"]!.map((x) => TransactionSMA.fromMap(x))),
    );
