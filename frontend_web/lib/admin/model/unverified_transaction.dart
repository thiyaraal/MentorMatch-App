...
//
//     final unverifiedTransaction = unverifiedTransactionFromMap(jsonString);

import 'dart:convert';

UnverifiedTransaction unverifiedTransactionFromMap(String str) =>
    UnverifiedTransaction.fromMap(json.decode(str));

String unverifiedTransactionToMap(UnverifiedTransaction data) =>
...
class UnverifiedTransaction {
  ...
  factory UnverifiedTransaction.fromMap(Map<String, dynamic> json) =>
      UnverifiedTransaction(
        error: json["error"],
