...
class SD {
  ...
  factory SD.fromMap(Map<String, dynamic> json) => SD(
        ...
        mentors: json["mentors"] == null
            ? []
            : List<MentorSD>.from(
                json["mentors"]!.map((x) => MentorSD.fromMap(x))),
      );
...
class MentorSD {
  ...
  factory MentorSD.fromMap(Map<String, dynamic> json) => MentorSD(
        ...
        mentorClass: json["class"] == null
            ? []
            : List<ClassMentorSD>.from(
                json["class"]!.map((x) => ClassMentorSD.fromMap(x))),
        mentorReviews: json["mentorReviews"] == null
            ? []
            : List<MentorReviewSD>.from(
                json["mentorReviews"]!.map((x) => MentorReviewSD.fromMap(x))),
        experiences: json["experiences"] == null
            ? []
            : List<ExperienceSD>.from(
                json["experiences"]!.map((x) => ExperienceSD.fromMap(x))),
      );
...
class ClassMentorSD {
  ...
  factory ClassMentorSD.fromMap(Map<String, dynamic> json) => ClassMentorSD(
        ...
        transactions: json["transactions"] == null
            ? []
            : List<TransactionSD>.from(
                json["transactions"]!.map((x) => TransactionSD.fromMap(x))),
      );
