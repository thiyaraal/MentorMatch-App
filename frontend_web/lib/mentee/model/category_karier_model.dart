...
class Karier {
  ...
  factory Karier.fromMap(Map<String, dynamic> json) => Karier(
        ...
        mentors: json["mentors"] == null
            ? []
            : List<MentorKarier>.from(
                json["mentors"]!.map((x) => MentorKarier.fromMap(x))),
      );
...
class MentorKarier {
  ...
  List<MentorReviewKarier>? mentorReviews;
  ...
  factory MentorKarier.fromMap(Map<String, dynamic> json) => MentorKarier(
        ...
        mentorClass: json["class"] == null
            ? []
            : List<ClassMentorKarier>.from(
                json["class"]!.map((x) => ClassMentorKarier.fromMap(x))),
        mentorReviews: json["mentorReviews"] == null
            ? []
            : List<MentorReviewKarier>.from(
                json["mentorReviews"]!.map((x) => MentorReviewKarier.fromMap(x))),
        experiences: json["experiences"] == null
            ? []
            : List<ExperienceKarier>.from(
                json["experiences"]!.map((x) => ExperienceKarier.fromMap(x))),
      );
...
class ClassMentorKarier {
  ...
  factory ClassMentorKarier.fromMap(Map<String, dynamic> json) => ClassMentorKarier(
        ...
        transactions: json["transactions"] == null
            ? []
            : List<TransactionKarier>.from(
                json["transactions"]!.map((x) => TransactionKarier.fromMap(x))),
      );
...
class MentorReviewKarier {
  ...
  factory MentorReviewKarier.fromMap(Map<String, dynamic> json) => MentorReviewKarier(
        id: json["id"],
