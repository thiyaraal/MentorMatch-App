...
class MentorKuliah {
  ...
  factory MentorKuliah.fromMap(Map<String, dynamic> json) => MentorKuliah(
        ...
        mentorClass: json["class"] == null
            ? []
            : List<ClassMentorKuliah>.from(
                json["class"]!.map((x) => ClassMentorKuliah.fromMap(x))),
        mentorReviews: json["mentorReviews"] == null
            ? []
            : List<MentorReviewKuliah>.from(json["mentorReviews"]!
                .map((x) => MentorReviewKuliah.fromMap(x))),
        experiences: json["experiences"] == null
            ? []
            : List<ExperienceKuliah>.from(
                json["experiences"]!.map((x) => ExperienceKuliah.fromMap(x))),
      );
...
class ExperienceKuliah {
  ...
  factory ExperienceKuliah.fromMap(Map<String, dynamic> json) =>
      ExperienceKuliah(
        id: json["id"],
        userId: json["userId"],
...
class ClassMentorKuliah {
  ...
  factory ClassMentorKuliah.fromMap(Map<String, dynamic> json) =>
      ClassMentorKuliah(
        id: json["id"],
        ...
        transactions: json["transactions"] == null
            ? []
            : List<TransactionKuliah>.from(
                json["transactions"]!.map((x) => TransactionKuliah.fromMap(x))),
      );
...
class TransactionKuliah {
  ...
  factory TransactionKuliah.fromMap(Map<String, dynamic> json) =>
      TransactionKuliah(
        id: json["id"],
...
class MentorReviewKuliah {
  ...
  factory MentorReviewKuliah.fromMap(Map<String, dynamic> json) =>
      MentorReviewKuliah(
        id: json["id"],
